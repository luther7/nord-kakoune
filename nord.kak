...
%sh{
   ...
   echo "
        ...
        face global PrimarySelection   ${nord4},${nord3}
        face global SecondarySelection ${nord9},${nord10}
        face global PrimaryCursor      ${nord3},${nord4}
        ...
        face global LineNumbers        ${nord4},${nord2}
        face global LineNumberCursor   ${nord10},${nord2}
        face global LineNumbersWrapped ${nord10},${nord2}
        face global MenuForeground     ${nord4},${nord2}
        face global MenuBackground     ${nord4},${nord2}
        face global MenuInfo           ${nord2}
        face global Information        ${nord4},${nord2}
        face global Error              ${nord11},default+b
        face global StatusLine         ${nord4},${nord2}+b
        face global StatusLineMode     ${nord2}
        face global StatusLineInfo     ${nord8}
        face global StatusLineValue    ${nord7}
        face global StatusCursor       ${nord4},${nord2}
        face global Prompt             ${nord4}+b
        face global MatchingChar       ${nord4},${nord2}+b
        face global BufferPadding      ${nord4},${nord9}
    "
}
